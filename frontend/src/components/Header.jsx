  ...
  <div className='ftco-navbar-light flex justify-between items-center bg-white z-3 py-2 px-4 shadow-md md:relative md:top-0 md:py-2 md:px-6'>
    ...
    <div className='flex py-2 px-4'>
      ...
      {user && user.role === 'user' ? (
        ...
        <span className='mx-16 font-semibold uppercase text-base  hover:text-green-500' style={{paddingTop: '2.3rem', paddingBottom: '2.3rem', paddingLeft: '18px', paddingRight: '18px', fontWeight: '700', position: 'relative', opacity: '1', color: 'green'}}>Admin</span>
      ) : (
